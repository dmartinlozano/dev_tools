...
from installer.src.utils import apply_kubectl, get_secret
...
class CertManager:
    ...
    def create_service_account(self):
        ...
        service_accounts = self.core_api.list_namespaced_service_account(namespace=config.namespace)
        ...
        if sa_exists:
            ...
            self.core_api.create_namespaced_service_account(namespace=config.namespace, body=sa_body)
