...
# echo "    Checking devtools client..."
# CLIENT_EXISTS=$(curl -k -s -H "Authorization: Bearer ${ADMIN_TOKEN}" \
#     "http://${KEYCLOAK_HOSTNAME}/admin/realms/devtools/clients" | \
#     grep -o '"clientId":"devtools"')  

# if [ -z "$CLIENT_EXISTS" ]; then
#     echo "    Creating devtools client..."
#     RESPONSE=$(curl -k -s -X POST \
#         -H "Authorization: Bearer ${ADMIN_TOKEN}" \
#         -H "Content-Type: application/json" \
#         -d "{
...
#     else
#         echo "    Devtools client created successfully."
#     fi  
# fi
